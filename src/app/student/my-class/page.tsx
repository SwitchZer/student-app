                  ...
                  <div className="flex flex-col gap-2 justify-center p-4 mt-10 w-full bg-white rounded-2xl max-md:max-w-full">
                    <div className="flex gap-4 w-full max-md:max-w-full">
                      <div className="flex flex-col flex-1 shrink basis-0">
                        ...
                        <div className="gap-2.5 pb-2 mt-3 w-full text-5xl font-medium leading-tight text-center text-white whitespace-nowrap bg-red-400 rounded-2xl min-h-[140px] max-md:text-4xl">
                          2
                        </div>
                      </div>
                      <div className="flex flex-col flex-1 shrink font-medium whitespace-nowrap basis-0">
                        ...
                        <div className="gap-2.5 pb-2 mt-3 w-full text-5xl leading-tight text-center text-white bg-orange-300 rounded-2xl min-h-[190px] max-md:text-4xl">
                          1
                        </div>
                      </div>
                      <div className="flex flex-col flex-1 shrink basis-0">
                        ...
                        <div className="gap-2.5 pb-2 mt-3 w-full text-5xl font-medium leading-tight text-center text-white whitespace-nowrap bg-teal-300 rounded-2xl min-h-[110px] max-md:text-4xl">
                          3
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex flex-col flex-1 w-full max-md:max-w-full">
                ...
                <div className="flex flex-col justify-center p-6 mt-4 w-full bg-white rounded-3xl shadow-sm max-md:px-5 max-md:max-w-full">
                  <div className="flex gap-5 items-start w-full max-md:max-w-full">
                    <div className="flex flex-col flex-1 shrink justify-center px-6 pt-6 pb-5 w-full bg-orange-50 rounded-3xl border border-orange-300 border-solid shadow-sm basis-0 min-w-[240px] max-md:px-5 max-md:max-w-full">
                  ...
                  <div className="flex flex-col gap-2 justify-center px-0 py-5 mt-6 w-full rounded-3xl bg-stone-50 max-md:max-w-full">
                    <div className="flex flex-col px-5 w-full max-md:max-w-full">
                      ...
                      <div className="flex-1 shrink gap-2.5 self-stretch px-5 mt-2 w-full text-sm leading-6 text-zinc-500 max-md:max-w-full">
                      ...
                      <div className="flex flex-col px-5 w-full max-md:max-w-full">
                        <div className="flex gap-10 justify-between items-center w-full h-[39px]">
                          <div className="flex gap-2.5 items-center self-stretch my-auto">
                            ...
                            <div className="flex flex-col justify-center self-stretch my-auto w-[102px]">
                              <div className="text-base font-medium leading-loose text-neutral-900">
                                Charlie White
                              </div>
                              <div className="text-xs leading-tight text-zinc-500">
                                CLASS 8B
                          ...
                          <div className="flex gap-1 items-center self-stretch p-2 py-1 my-auto text-xs font-medium leading-none whitespace-nowrap bg-white rounded-lg border border-solid border-neutral-500 min-h-[32px] text-neutral-500">
                            <Image
                              loading="lazy"
                              src=""
                              className="object-contain shrink-0 self-stretch my-auto w-4 aspect-square"
                          ...
                          <div className="flex gap-2.5 items-center self-stretch my-auto">
                            <div className="flex flex-col self-stretch my-auto w-10 min-h-[40px]">
                              <Image
                                loading="lazy"
                                src=""
                                className="object-contain w-10 aspect-[2.67]"
                              />
                            </div>
                            <div className="self-stretch my-auto text-base font-medium leading-loose text-neutral-900 w-[102px]">
                              Charlie White
                            </div>
                          </div>
                          <div className="flex gap-1 items-center self-stretch px-2 py-1 pt-2 my-auto text-xs font-medium leading-none whitespace-nowrap bg-white rounded-lg border border-solid border-neutral-500 min-h-[32px] text-neutral-500">
                            <Image
                              loading="lazy"
                              src=""
                              className="object-contain shrink-0 self-stretch my-auto w-4 aspect-[5.32]"
                            />
                            <div className="self-stretch my-auto">
                              Responsible
                            </div>
